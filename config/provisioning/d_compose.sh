...
export WEBUI_FLAGS='--gradio-debug --ui-config-file '/workspace/stable-diffusion-webui/extensions/stable-diffusion-webui-forge/webui-user.bat' --autolaunch'
...
export IMAGE_SLUG='stable-diffusion-webui-forge'
...
export WEBUI_BRANCH='https://github.com/lllyasviel/stable-diffusion-webui-forge'
export SUPERVISOR_START_CLOUDFLARED='0'
export PROVISIONING_SCRIPT='https://raw.githubusercontent.com/Roldondo/stable-diffusion-webui/main/config/provisioning/bongo.sh'
...
export workspace_SYNC='stable-diffusion-webui-forge'
