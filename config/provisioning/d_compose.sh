...
export WEBUI_FLAGS='--gradio-debug --x-formers --enable-insecure-extension-access --disable-safe-unpickle --deforum-api --upcast-sampling --ui-config-file 'webui.bat' --ui-settings-file 'webui-user.sh' --autolaunch'
