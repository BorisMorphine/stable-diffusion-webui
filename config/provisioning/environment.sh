...
export WEBUI_FLAGS='--administrator --reinstall-torch --reinstall-xformers --force-enable-xformers --enable-insecure-extension-access --disable-safe-unpickle --update-all-extensions --upcast-sampling --deepdanbooru --api --deforum-api'
...
export WORKSPACE_MOUNTED='false'
export PUBLIC_IPADDR='62.3.66.254'
export OPT_SYNC='stable-diffusion-webui-forge'
export LC_ALL='C.UTF-8'
export WORKSPACE_GID='1111'
export WEB_USER='user'
export VAST_TCP_PORT_8888='10046'
...
export CUDA_LEVEL='runtime'
export MAMBA_INSTALL='micromamba install --always-softlink -y -c pytorch -c nvidia -c conda-forge'
export GIT_CLONE='https://github.com/lllyasviel/stable-diffusion-webui-forge.git'
export DEBIAN_FRONTEND='noninteractive'
export DATA_DIRECTORY='/opt/'
export WORKSPACE_UID='1000'
export OLDPWD='/'
